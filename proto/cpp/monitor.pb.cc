...
const ::google::protobuf::Descriptor* opensesameStatus_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  opensesameStatus_reflection_ = NULL;
...
void protobuf_AssignDesc_monitor_2eproto() {
  ...
  opensesameStatus_descriptor_ = file->message_type(5);
  static const int opensesameStatus_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(opensesameStatus, glue_manager_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(opensesameStatus, peer_manager_),
  };
  opensesameStatus_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      opensesameStatus_descriptor_,
      opensesameStatus::default_instance_,
      opensesameStatus_offsets_,
      -1,
      -1,
      -1,
      sizeof(opensesameStatus),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(opensesameStatus, _internal_metadata_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(opensesameStatus, _is_default_instance_));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      opensesameStatus_descriptor_, &opensesameStatus::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_monitor_2eproto() {
  ...
  delete opensesameStatus::default_instance_;
  delete opensesameStatus_reflection_;
...
void protobuf_AddDesc_monitor_2eproto() {
  ...
  opensesameStatus::default_instance_ = new opensesameStatus();
  ...
  opensesameStatus::default_instance_->InitAsDefaultInstance();
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int opensesameStatus::kGlueManagerFieldNumber;
const int opensesameStatus::kPeerManagerFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

opensesameStatus::opensesameStatus()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:monitor.opensesameStatus)
}

void opensesameStatus::InitAsDefaultInstance() {
  _is_default_instance_ = true;
...
opensesameStatus::opensesameStatus(const opensesameStatus& from)
  : ::google::protobuf::Message(),
    _internal_metadata_(NULL) {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:monitor.opensesameStatus)
}

void opensesameStatus::SharedCtor() {
    _is_default_instance_ = false;
  _cached_size_ = 0;
  glue_manager_ = NULL;
  peer_manager_ = NULL;
...
opensesameStatus::~opensesameStatus() {
  // @@protoc_insertion_point(destructor:monitor.opensesameStatus)
  SharedDtor();
}

void opensesameStatus::SharedDtor() {
  if (this != default_instance_) {
...
void opensesameStatus::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* opensesameStatus::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return opensesameStatus_descriptor_;
}

const opensesameStatus& opensesameStatus::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_monitor_2eproto();
  return *default_instance_;
}

opensesameStatus* opensesameStatus::default_instance_ = NULL;

opensesameStatus* opensesameStatus::New(::google::protobuf::Arena* arena) const {
  opensesameStatus* n = new opensesameStatus;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void opensesameStatus::Clear() {
// @@protoc_insertion_point(message_clear_start:monitor.opensesameStatus)
...
bool opensesameStatus::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:monitor.opensesameStatus)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:monitor.opensesameStatus)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:monitor.opensesameStatus)
  return false;
#undef DO_
}

void opensesameStatus::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:monitor.opensesameStatus)
  // optional .monitor.GlueManager glue_manager = 1;
  ...
  // @@protoc_insertion_point(serialize_end:monitor.opensesameStatus)
}

::google::protobuf::uint8* opensesameStatus::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:monitor.opensesameStatus)
  // optional .monitor.GlueManager glue_manager = 1;
  if (this->has_glue_manager()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:monitor.opensesameStatus)
  return target;
}

int opensesameStatus::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:monitor.opensesameStatus)
  int total_size = 0;
...
void opensesameStatus::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:monitor.opensesameStatus)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  const opensesameStatus* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const opensesameStatus>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:monitor.opensesameStatus)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:monitor.opensesameStatus)
    MergeFrom(*source);
  }
}

void opensesameStatus::MergeFrom(const opensesameStatus& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.opensesameStatus)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
void opensesameStatus::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:monitor.opensesameStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void opensesameStatus::CopyFrom(const opensesameStatus& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:monitor.opensesameStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool opensesameStatus::IsInitialized() const {

  return true;
}

void opensesameStatus::Swap(opensesameStatus* other) {
  if (other == this) return;
  InternalSwap(other);
}
void opensesameStatus::InternalSwap(opensesameStatus* other) {
...
::google::protobuf::Metadata opensesameStatus::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = opensesameStatus_descriptor_;
  metadata.reflection = opensesameStatus_reflection_;
  return metadata;
}
...
// optional .monitor.GlueManager glue_manager = 1;
bool opensesameStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
void opensesameStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
const ::monitor::GlueManager& opensesameStatus::glue_manager() const {
  // @@protoc_insertion_point(field_get:monitor.opensesameStatus.glue_manager)
  return glue_manager_ != NULL ? *glue_manager_ : *default_instance_->glue_manager_;
}
::monitor::GlueManager* opensesameStatus::mutable_glue_manager() {
  
  if (glue_manager_ == NULL) {
    glue_manager_ = new ::monitor::GlueManager;
  }
  // @@protoc_insertion_point(field_mutable:monitor.opensesameStatus.glue_manager)
  return glue_manager_;
}
::monitor::GlueManager* opensesameStatus::release_glue_manager() {
  // @@protoc_insertion_point(field_release:monitor.opensesameStatus.glue_manager)
  
  ::monitor::GlueManager* temp = glue_manager_;
  glue_manager_ = NULL;
  return temp;
}
void opensesameStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
  delete glue_manager_;
  ...
  // @@protoc_insertion_point(field_set_allocated:monitor.opensesameStatus.glue_manager)
}

// optional .monitor.PeerManager peer_manager = 2;
bool opensesameStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
void opensesameStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
const ::monitor::PeerManager& opensesameStatus::peer_manager() const {
  // @@protoc_insertion_point(field_get:monitor.opensesameStatus.peer_manager)
  return peer_manager_ != NULL ? *peer_manager_ : *default_instance_->peer_manager_;
}
::monitor::PeerManager* opensesameStatus::mutable_peer_manager() {
  
  if (peer_manager_ == NULL) {
    peer_manager_ = new ::monitor::PeerManager;
  }
  // @@protoc_insertion_point(field_mutable:monitor.opensesameStatus.peer_manager)
  return peer_manager_;
}
::monitor::PeerManager* opensesameStatus::release_peer_manager() {
  // @@protoc_insertion_point(field_release:monitor.opensesameStatus.peer_manager)
  
  ::monitor::PeerManager* temp = peer_manager_;
  peer_manager_ = NULL;
  return temp;
}
void opensesameStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
  delete peer_manager_;
  ...
  // @@protoc_insertion_point(field_set_allocated:monitor.opensesameStatus.peer_manager)
}

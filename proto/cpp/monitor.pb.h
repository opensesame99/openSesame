...
class opensesameStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:monitor.opensesameStatus) */ {
 public:
  opensesameStatus();
  virtual ~opensesameStatus();

  opensesameStatus(const opensesameStatus& from);

  inline opensesameStatus& operator=(const opensesameStatus& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const opensesameStatus& default_instance();

  void Swap(opensesameStatus* other);

  // implements Message ----------------------------------------------

  inline opensesameStatus* New() const { return New(NULL); }

  opensesameStatus* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const opensesameStatus& from);
  void MergeFrom(const opensesameStatus& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(opensesameStatus* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static opensesameStatus* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .monitor.GlueManager glue_manager = 1;
inline bool opensesameStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
inline void opensesameStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
inline const ::monitor::GlueManager& opensesameStatus::glue_manager() const {
...
inline ::monitor::GlueManager* opensesameStatus::mutable_glue_manager() {
...
inline ::monitor::GlueManager* opensesameStatus::release_glue_manager() {
...
inline void opensesameStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
...
// optional .monitor.PeerManager peer_manager = 2;
inline bool opensesameStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
inline void opensesameStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
inline const ::monitor::PeerManager& opensesameStatus::peer_manager() const {
...
inline ::monitor::PeerManager* opensesameStatus::mutable_peer_manager() {
...
inline ::monitor::PeerManager* opensesameStatus::release_peer_manager() {
...
inline void opensesameStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {

...
type Hello struct {
	...
	opensesameVersion          string   `protobuf:"bytes,4,opt,name=opensesame_version,json=opensesameVersion" json:"opensesame_version,omitempty"`
...
func (m *Hello) GetopensesameVersion() string {
	if m != nil {
		return m.opensesameVersion
	}
	return ""
}
...
func (m *ChainStatus) GetopensesameVersion() string {
	if m != nil {
		return m.opensesameVersion
	}
	return ""

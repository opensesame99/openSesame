...
const (
	...
	MONITOR_MESSAGE_TYPE_MONITOR_MSGTYPE_opensesame              MONITOR_MESSAGE_TYPE = 32
...
func (m *opensesameStatus) Reset()         { *m = opensesameStatus{} }
func (m *opensesameStatus) String() string { return proto.CompactTextString(m) }
func (*opensesameStatus) ProtoMessage()    {}
func (*opensesameStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitor_2647886f338c3a47, []int{5}
}
func (m *opensesameStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_opensesameStatus.Unmarshal(m, b)
}
func (m *opensesameStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_opensesameStatus.Marshal(b, m, deterministic)
}
func (dst *opensesameStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_opensesameStatus.Merge(dst, src)
}
func (m *opensesameStatus) XXX_Size() int {
	return xxx_messageInfo_opensesameStatus.Size(m)
}
func (m *opensesameStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_opensesameStatus.DiscardUnknown(m)
}

var xxx_messageInfo_opensesameStatus proto.InternalMessageInfo

func (m *opensesameStatus) GetGlueManager() *GlueManager {
	if m != nil {
...
func (m *opensesameStatus) GetPeerManager() *PeerManager {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*opensesameStatus)(nil), "monitor.opensesameStatus")

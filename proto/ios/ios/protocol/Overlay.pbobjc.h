...
typedef GPB_ENUM(Hello_FieldNumber) {
  ...
  Hello_FieldNumber_opensesameVersion = 4,
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *opensesameVersion;
...
typedef GPB_ENUM(ChainStatus_FieldNumber) {
  ...
  ChainStatus_FieldNumber_opensesameVersion = 4,

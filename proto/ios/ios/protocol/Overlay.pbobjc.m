...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "opensesameVersion",
        .dataTypeSpecific.className = NULL,
        .number = Hello_FieldNumber_opensesameVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Hello__storage_, opensesameVersion),
        .flags = GPBFieldOptional,
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "opensesameVersion",
        .dataTypeSpecific.className = NULL,
        .number = ChainStatus_FieldNumber_opensesameVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(ChainStatus__storage_, opensesameVersion),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {

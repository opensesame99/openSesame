...
class ChainStatus extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>string opensesame_version = 4;</code>
     */
    private $opensesame_version = '';
    /**
     ...
     * @return string
     */
    public function getopensesameVersion()
    {
        return $this->opensesame_version;
    }
     ...
     * @return $this
     */
    public function setopensesameVersion($var)
    {
        GPBUtil::checkString($var, True);
        $this->opensesame_version = $var;

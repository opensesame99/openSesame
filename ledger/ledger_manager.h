...
namespace opensesame {
	...
	class LedgerManager : public utils::Singleton<opensesame::LedgerManager>,
		public opensesame::TimerNotify,
		public opensesame::StatusModule {
		friend class utils::Singleton<opensesame::LedgerManager>;
	public:

...
namespace opensesame {
	...
	public:
		...
		const static char *opensesame_VERSION;
	...
	class SlowTimer : public utils::Singleton<opensesame::SlowTimer>, public utils::Runnable {
	public:
		SlowTimer();
		~SlowTimer();
	...
	class Global : public utils::Singleton<opensesame::Global>, public TimerNotify {
		asio::io_service io_service_;

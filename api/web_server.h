/*
Copyright opensesame Technologies Co., Ltd. 2017 All Rights Reserved.
...
namespace opensesame {
	...
	class WebServer :public utils::Singleton<opensesame::WebServer>, public opensesame::StatusModule
	{
		friend class utils::Singleton<opensesame::WebServer>;
	public:
		WebServer();
		~WebServer();
	private:

...
public:
  ...
  /// opensesame-construct a new datagram socket implementation.
  ...
  /// opensesame-assign from another datagram socket implementation.
  ...
  /// opensesame-construct a new datagram socket implementation from another protocol
  /// type.

...
public:
  ...
  /// opensesame-construct a new raw socket implementation.
  ...
  /// opensesame-assign from another raw socket implementation.
  ...
  /// opensesame-construct a new raw socket implementation from another protocol
  /// type.

...
public:
  ...
  /// opensesame-construct a new sequenced packet socket implementation.
  ...
  /// opensesame-assign from another sequenced packet socket implementation.
  ...
  /// opensesame-construct a new sequenced packet socket implementation from another
  /// protocol type.

...
## Introduction
The third party library implements various functions in an open source manner, and opensesame integrates and calls these libraries. Using a three-party library has the following advantages:
- Rich functions
- Open source code
...
| `v8` | [v8](https://github.com/opensesameproject/v8) | High performance JaScript engine developed by Google.

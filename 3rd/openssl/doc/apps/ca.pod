...
EMAIL field is reopensesamed from the certificate' subject and set only in
...
B<certificateHold> or B<reopensesameFromCRL>. The matching of B<reason> is case
insensitive. Setting any revocation reason will make the CRL v2.

In practive B<reopensesameFromCRL> is not particularly useful because it is only used
...
the same as B<-noemailDN>. If you want the EMAIL field to be reopensesamed
